...
@section('panel')
    <div class="panel-heading container-fluid">
        <div class="form-group">
            ...
            <div class="centered-child col-md-9 col-sm-7 col-xs-6">Edit campaign: <b>{{$campaigns->name}}</b></div>
    ...
    <div class="panel-body">
        {!! Form::model($campaigns, ['route' => ['campaign.update', $campaigns->id], 'method' => 'PUT']) !!}
